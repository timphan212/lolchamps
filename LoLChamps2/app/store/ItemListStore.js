	...
	config: {
		...
		listeners: {
			beforeload: function(store, response, eOpts) {
				this.getProxy().setUrl('https://global.api.pvp.net/api/lol/static-data/' + LoLChamps.app.REGION + '/v1.2/item?locale=' + LoLChamps.app.LOCALE + '&itemListData=all&api_key=' + KeyObject.getApiKey());
