	...
	config: {
		...
		listeners: {
			beforeload: function(store, response, eOpts) {
				this.getProxy().setUrl('https://prod.api.pvp.net/api/lol/static-data/' + LoLChamps.app.REGION + '/v1.2/champion?locale=' + LoLChamps.app.LOCALE + '&champData=info&api_key=' + apiKey);
