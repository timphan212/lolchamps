	...
	config: {
		...
		listeners: {
			beforeload: function(store, response, eOpts) {
				this.getProxy().setUrl('https://' + LoLChamps.app.REGION + LoLChamps.app.API_URL + LoLChamps.app.REGION + '/v1.3/stats/by-summoner/' + LoLChamps.app.SUMMONER_ID + '/summary?season=' + LoLChamps.app.SEASON + '&api_key=' + apiKey);
