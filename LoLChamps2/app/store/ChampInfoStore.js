	...
	config: {
		...
		listeners: {
			beforeload: function(store, response, eOpts) {
				this.getProxy().setUrl(LoLChamps.app.API_URL+ 'static-data/' + LoLChamps.app.REGION + '/v1.2/champion/' + LoLChamps.app.CHAMPION_ID + '?locale=' + LoLChamps.app.LOCALE + '&champData=all&api_key=' + apiKey);
